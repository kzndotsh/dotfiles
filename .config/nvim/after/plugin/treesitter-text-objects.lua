    ...
    textobjects = {
        ...
        swap = {
            ...
            swap_next = {
                ...
                ["<leader>nnm"] = "@function.outer", -- swap function with next
            },
            swap_previous = {
                ["<leader>pa"] = "@parameter.inner", -- swap parameters/argument with prev
                ["<leader>p:"] = "@property.outer", -- swap object property with prev
                ["<leader>pnm"] = "@function.outer", -- swap function with previous
            },
        },
        move = {
            enable = true,
            ...
            goto_next_start = {
                ["<leader>nf"] = { query = "@call.outer", desc = "Next function call start" },
                ["<leader>nm"] = { query = "@function.outer", desc = "Next method/function def start" },
                ...
                ["<leader>ns"] = { query = "@scope", query_group = "locals", desc = "Next scope" },
                ["<leader>nz"] = { query = "@fold", query_group = "folds", desc = "Next fold" },
            },
            goto_next_end = {
                ["<leader>nF"] = { query = "@call.outer", desc = "Next function call end" },
                ["<leader>nM"] = { query = "@function.outer", desc = "Next method/function def end" },
                ["<leader>nC"] = { query = "@class.outer", desc = "Next class end" },
                ["<leader>nI"] = { query = "@conditional.outer", desc = "Next conditional end" },
                ["<leader>nL"] = { query = "@loop.outer", desc = "Next loop end" },
            },
            goto_previous_start = {
